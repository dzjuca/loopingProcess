function u_t = massBalanceFcn(g_b, g_e, estructC, Tbe, alpha,u,db, ...
...
% -------------------------------------------------------------------------
    elseif strcmp(id_1,'FSEstela')
        ...
        u_t = -mbrhs1Fcn(alpha,u,g_b,Global,id_1).*FC3                  ...
              +mbrhs2Fcn(alpha,u,g_b,g_e,Global,id_2).*FC3              ...
              -mbrhs3Fcn(alpha,db,[],g_b,g_e,[],[],Global,id_2,[]).*FC3 ...
              +mbrhs4Fcn(alpha,estructC,Tbe,Global,id_1,id_3).*FC3;
% -------------------------------------------------------------------------
    elseif strcmp(id_1,'FSEmulsion')

        FC4 = 1./((1-alpha-alpha*fw)*(1-Emf)*Dcat);
        u_t = +mbrhs1Fcn(alpha,u(:,2),g_e,Global,id_1).*FC4             ...
              -mbrhs2Fcn(alpha,u(:,1),g_b,g_e,Global,id_2).*FC4         ...
              +mbrhs3Fcn(alpha,db,[],g_b,g_e,[],[],Global,id_2,[]).*FC4 ...
